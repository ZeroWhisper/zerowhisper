...
export function toogleModalAdd(payload?: number) {
  return action(Interface.Types.TOOGLEMODALADD, payload);
}

export function toogleModalDel(payload?: number) {
  return action(Interface.Types.TOOGLEMODALDEL, payload);
}

export function addrequest() {
  return action(Interface.Types.ADDREQUEST);
}

export function removerequest(payload: number) {
  return action(Interface.Types.REMOVEREQUEST, payload);
}
...
//   return action(Interface.Types.MODALREMOVE, payload);
// }
